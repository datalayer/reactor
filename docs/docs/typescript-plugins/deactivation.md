...
The mirror image of [activation](/typescript-plugins/activation-events), and the reason
...
flag, and — if it declared [`preserveOutput`](/typescript-plugins/lifecycle) — what it
