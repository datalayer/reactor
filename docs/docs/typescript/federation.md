...
A [lazy plugin](/typescript/lazy-loading) already defers its module —
...
extension the server reported after a [`pip install`](/python/packaging),
...
[Packaging an extension](/python/packaging).
